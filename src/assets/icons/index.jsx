const icons = {
	...
	okClick: (props) => (
		<svg
			...
			className=""
			{...props}
		><path fill="currentColor" d="M9 17.2l-4-4-1.4 1.3L9 19.9 20.4 8.5 19 7.1 9 17.2z"></path></svg>
	),
	editPen: (props) => (
		<svg
			viewBox="0 0 24 24"
			...
			className=""
			{...props}
			><path fill="currentColor" d="M3.95 16.7v3.4h3.4l9.8-9.9-3.4-3.4-9.8 9.9zm15.8-9.1c.4-.4.4-.9 0-1.3l-2.1-2.1c-.4-.4-.9-.4-1.3 0l-1.6 1.6 3.4 3.4 1.6-1.6z"></path></svg>
	),
	endCallBtn: (props) => (
		<svg
			version="1.0"
			...
			><path d="M2380 5109 c-1036 -74 -1926 -768 -2250 -1757 -139 -427 -162 -909 -64 -1352 158 -707 622 -1325 1263 -1680 567 -314 1257 -398 1888 -230 882 235 1578 931 1813 1813 234 879 -20 1822 -664 2463 -450 448 -1006 699 -1644 743 -167 12 -173 12 -342 0z m-730 -935 c44 -20 97 -67 277 -247 254 -254 276 -286 276 -407 0 -106 -31 -161 -167 -299 -145 -148 -157 -182 -109 -336 108 -348 640 -871 975 -961 63 -16 146 -18 184 -4 15 6 82 64 148 129 140 137 178 157 291 155 117 -1 140 -17 396 -273 147 -146 235 -242 249 -271 32 -62 38 -169 15 -241 -16 -48 -39 -75 -213 -251 -210 -213 -235 -230 -355 -249 -77 -13 -203 2 -324 37 -550 159 -1343 789 -1859 1478 -203 270 -377 582 -452 809 -54 163 -65 227 -60 344 6 147 18 166 216 366 92 93 186 182 209 198 89 62 198 70 303 23z"/></g></svg>
	),
	acceptCallBtn: (props) => (
		<svg
			version="1.0"
	...
	videoCall: (props) => (
		<svg
			...
			<path d="M13 253 c-9 -3 -13 -31 -13 -88 0 -102 4 -105 115 -105 110 0 115 4
			115 98 0 47 -5 83 -12 90 -12 12 -179 16 -205 5z"/>
			<path d="M278 209 c-31 -16 -38 -25 -38 -49 0 -24 7 -33 40 -50 l40 -20 0 70
			c0 38 -1 70 -2 70 -2 -1 -20 -10 -40 -21z"/>
			</g>
			</svg>
